...
public class MovieServiceTests {
	...
	void setUp() {
		...
		Mockito.doThrow(DatabaseException.class).when(repository).deleteById(nonExistingId);
	...
	public void findByIdShouldReturnMovieDTOWhenIdExists() {
		...
		Assertions.assertEquals(dto.getScore(), movie.getScore());
		Assertions.assertEquals(dto.getCount(), movie.getCount());
		Assertions.assertEquals(dto.getImage(), movie.getImage());
	}
	...
	public void updateShouldThrowResourceNotFoundExceptionWhenIdDoesNotExist() {
		...
		Assertions.assertThrows(ResourceNotFoundException.class, () -> {
			MovieDTO dto = service.update(nonExistingId, movieDTO);
		});
	}
